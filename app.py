...
def home():
    return jsonify({
        "status": "success",
        "system": "نظام إدارة الرسائل المتقدم",
        "version": "2.0.0",
        "developer": "LONELY",
        "social": {
            "telegram": "@lonely_20072",
            "instagram": "@lonely.200724"
        },
        "endpoints": {
            "start_spam": {
                "method": "GET",
                "url": "/spam",
                "parameters": {
                    "user_id": "معرف المستخدم الهدف",
                    "duration": "مدة السبام بالدقائق (اختياري)"
                },
                "example": "/spam?user_id=123456789&duration=5"
            },
            "stop_spam": {
                "method": "GET",
                "url": "/stop",
                ...
                "example": "/stop?user_id=123456789"
            },
            "get_status": {
                "method": "GET",
                "url": "/status",
                "description": "الحصول على حالة النظام والأهداف النشطة"
            },
            "get_accounts": {
                "method": "GET",
                "url": "/accounts",
                "description": "الحصول على قائمة الحسابات المتصلة"
            }
        },
        "features": [
            "دعم متعدد الحسابات",
        ...
        "note": "النظام يفتح روم الدردشة أولاً قبل إرسال الرسائل لضمان أفضل أداء",
        "contact": "للتواصل والدعم الفني"
    })
def run_api():
    print("🌐 بدء تشغيل API...")
